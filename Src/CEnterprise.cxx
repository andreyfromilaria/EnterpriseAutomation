...
namespace Ilaria
{
    ...
    real CEnterprise::GetStocks()
    {
        return _Stocks;
    };
    
    real CEnterprise::GetValueAddedTax()
    {
    ...
    real CEnterprise::GetDefferedIncome()
    {
        return _DefferedIncome;
    };
    
    real CEnterprise::GetLongTermCommitment()
    {
        return _LongTermCommitment;
    };
    
    real CEnterprise::GetLoans()
    {
        return _Loans;
    };
    
    real CEnterprise::GetCapitalAndReserves()
    {
        return _CapitalAndReserves;
    };
    
    real CEnterprise::GetTargetFinancingAndReceipts()
    {
        return _TargetFinancingAndReceipts;
    };
    
    real CEnterprise::GetNonCurrentAssets()
    {
        return _NonCurrentAssets;
    };
    
    real CEnterprise::GetCurrentAssets()
    {
        return _CurrentAssets;
    };
    
    real CEnterprise::GetRevenueFromSaleOfGoods()
    {
        return _RevenueFromSaleOfGoods;
    };
    
    real CEnterprise::GetBusinessExpenses()
    {
        return _BusinessExpenses;
    };
    
    real CEnterprise::GetAssets()
    {
        return _Assets;
    };
    
    real CEnterprise::GetManagementCosts()
    {
        return _ManagementCosts;
    };
    
    real CEnterprise::GetPayables()
    {
        return _Payables;
    };
    
    real CEnterprise::GetDebtParticipants()
    {
        return _DebtParticipants;
    };
    
    real CEnterprise::GetCostOfGoodSold()
    {
        return _CostOfGoodSold;
    };
    
    real CEnterprise::GetProfitBeforeTax()
    {
        return _ProfitBeforeTax;
    };
    
    real CEnterprise::GetIncomeTax()
    {
        return _IncomeTax;
    };
    
    real CEnterprise::GetNonOperatingIncome()
    {
    ...
    real CEnterprise::GetTotalAssets()
    {
        return _TotalAssets;
    };
    
    real CEnterprise::GetBorrowings()
    {
        return _Borrowings;
    };
    
    real CEnterprise::GetTotalLiabilities()
    {
        return _TotalLiabilities;
    };
    
    real CEnterprise::GetNetWorkingCapital()
    {
        return _NetWorkingCapital;
    };
    
    real CEnterprise::GetInterestPayable()
    {
        return _InterestPayable;
    };
    
    real CEnterprise::GetMarketValueOfEquity()
    {
        return _MarketValueOfEquity;
    };
    
    real CEnterprise::GetCostTotalDebt()
    {
        return _CostTotalDebt;
    };
    
    real CEnterprise::GetTangibleAssets()
    {
        return _TangibleAssets;
    };
    
    real CEnterprise::GetShortTermliabilities()
    {
        return _ShortTermliabilities;
    };
    
    real CEnterprise::GetOperatingAssets()
    {
        return _OperatingAssets;
    };
    
    real CEnterprise::GetOperatingExpenses()
    {
        return _OperatingExpenses;
    };
    
    real CEnterprise::GetNetProfitOfTheReportingPeriod()
    {
        return _NetProfitOfTheReportingPeriod;
    };
    
    real CEnterprise::GetEquity()
    {
        return _Equity;
    };
    
    real CEnterprise::GetMostLiqilineAssets()
    {
        return _MostLiqilineAssets;
    };
    
    real CEnterprise::GetNetLoss()
    {
        return _NetLoss;
    };
