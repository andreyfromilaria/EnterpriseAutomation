...
CExcelFormatManager::CExcelFormatManager(CExcel& xls)
 :	_xls(xls),
...
int CExcelFormatManager::GetFontIndex(const TExcelFont& font)
{
	int i = 0;
...
const Workbook::Font& CExcelFormatManager::GetFont(const TCellFormat& fmt) const
{
	size_t font_idx = fmt.GetFontIndex();
...
wstring CExcelFormatManager::GetFormatString(const TCellFormat& fmt) const
{
	int fmt_idx = fmt.GetFormatIndex();
...
int CExcelFormatManager::GetFormatIndex(const wstring& fmt_str)
{
...
int CExcelFormatManager::GetXFIndex(const TCellFormat& fmt)
{
	int i = 0;
